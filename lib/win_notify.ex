defmodule WinNotify do
  ...
  ## Example
      ...
      iex> 12345
  """
  @spec init_notify_icon :: integer | exception
  ...
  ## Example
      ...
      iex> :ok
  """
  @spec set_text(integer, String.t) :: :ok | {:error, String.t} | exception
  ...
  ## Example
      ...
      iex> :ok
  """
  @spec toggle_visibility(integer) :: :ok | {:error, String.t} | exception
  ...
  ## Example
      ...
      iex> :ok
  """
  @spec show_balloon_tip(integer, String.t, String.t, atom) :: :ok | {:error, String.t} | exception
  ...
  ## Example
      ...
      iex> :ok
  """
  @spec destroy_icon(integer) :: :ok | {:error, String.t} | exception
  ...
  ## Example
      ...
      iex> :ok
  """
  @spec wipe_all_icons :: :ok | exception
  ...
  ## Example
      ...
      iex> 2
  """
  @spec icon_count :: integer | exception
  def icon_count do
  ...
  """
  @spec list_icons :: [integer] | exception
  def list_icons do
